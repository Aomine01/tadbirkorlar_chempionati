...
import ExpertSix from "../assets/experts/p6.webp";
...
const experts = [
  ...
  {
    name: "Abdujalolov Muhammad",
    company: '"YESS COFFEE" brendi asoschisi',
    image: ExpertSix,
  },
];
...
const ExpertCard = ({ expert }: { expert: (typeof experts)[0] }) => (
  <div className="shrink-0 w-[240px] sm:w-[280px] md:w-[300px] select-none">
    <div className="rounded-2xl overflow-hidden bg-[#111] border border-white/10 relative aspect-[3/4]">
      <img
        src={expert.image}
        alt={expert.name}
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to top, rgba(0,0,0) 0%, transparent 100%)",
        }}
      >
        <h3 className="text-lg sm:text-2xl font-bold">{expert.name}</h3>
        <p
...
const Experts = () => {
  return (
    <section id="experts" className="relative py-20 sm:py-28 overflow-hidden">
      <Container>
      ...
      <div className="relative">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(to right, #000001, transparent)",
          }}
        />
        {/* Right fade */}
        <div
          ...
          style={{
            background: "linear-gradient(to left, #000001, transparent)",
          }}
        />
        <Marquee gap={30}>

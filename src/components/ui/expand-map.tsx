    ...
    >
      <motion.div
        ...
        animate={{
          ...
          height: isExpanded ? 140 : 140, // Keeping original size behavior
        }}
        transition={{
          type: "spring",
          stiffness: 400,
      ...
      >
          ...
          {isExpanded && (
            ...
            >
              ...
              >
                ...
                >
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7z" fill="#aca3ff" />
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-5">
          ...
          <div className="flex items-start justify-between">
            <div className="relative">
              ...
              >
                ...
                <motion.svg
                  ...
                  className="text-[#aca3ff]"
                  animate={{
                    filter: isHovered
                      ? "drop-shadow(0 0 8px rgba(172, 163, 255, 0.6))"
                      : "drop-shadow(0 0 4px rgba(172, 163, 255, 0.3))",
                  }}
                  transition={{ duration: 0.3 }}
                >
            ...
            >
              <div className="w-1.5 h-1.5 rounded-full bg-[#aca3ff]" />
          ...
          <div className="space-y-1">
            ...
            {/* Animated underline */}
            <motion.div
              className="h-px bg-gradient-to-r from-[#aca3ff]/50 via-[#aca3ff]/30 to-transparent"
